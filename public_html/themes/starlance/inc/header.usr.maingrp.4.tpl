<!-- Если пользователь не из группы ФРИЛАНСЕРЫ  - шлём его на Аляску! -->
		...
		<nav class="uk-navbar-height uk-navbar-container uk-container uk-container-large uk-navbar-transparent" uk-navbar>
			...
			<div class="uk-navbar-left uk-visible@m">
				...
				<ul class="uk-navbar-nav uk-light">
					...
					<!-- ENDIF -->
					<button class="uk-button uk-button-small uk-button-success" uk-tooltip="{PHP.L.Maingroup}" >{PHP.cot_groups.4.name}</button>
				</ul>
			</div>
...
<div id="User-Account" uk-offcanvas="flip: true; overlay: true">
    <div class="uk-offcanvas-bar">
        ...
        <div class="uk-panel uk-margin-remove-top">
			...
			<span uk-icon="users" class="uk-margin-small-right uk-icon"></span><span class="uk-visible@s uk-text-middle uk-text-success">{PHP.L.Maingroup}:</span> <span class="uk-text-middle uk-text-warning">{PHP.cot_groups.4.name}</span>
			</p>
			<hr class="uk-divider-icon uk-margin-remove">
        </div>	
        <ul class="uk-nav uk-nav-default">
			...
			<!-- IF {PHP.cot_modules.services} -->			
				<li class="uk-parent">
					<a class="" href="#"><span class="uk-text-lgrey uk-text-uppercase">{PHP.L.services_myproducts}</span> </a>
					<ul class="uk-nav-sub uk-list uk-list-divider">
						<li><a class="uk-color-f5" href="{PHP.usr.id|cot_url('users', 'm=details&id=$this&tab=services')}" data-offset="50">{PHP.L.services_myproducts_tab}</a></li>
						<!-- IF {PHP.cot_plugins_active.orderservices} -->
						<li><a class="uk-color-f5" href="{PHP|cot_url('orderservices', 'm=sales')}">{PHP.L.orderservices_mysales}</a></li>
						<li><a class="uk-color-f5" href="{PHP|cot_url('orderservices', 'm=purchases')}">{PHP.L.orderservices_mypurchases}</a></li>
						<!-- ENDIF -->
						<li><a class="uk-color-f5" href="{PHP|cot_url('services', 'm=add')}">{PHP.L.services_add_product}</a></li>
					</ul>
				</li>
				<li class="uk-nav-divider"></li>			
			<!-- ENDIF -->
