...
<div class="uk-background-default uk-section uk-padding-small">
	<div class="uk-container uk-container-large">
		...
		<div class="uk-child-width-1-2@m uk-child-width-1-2@l uk-child-width-1-2@xl uk-margin-small-top uk-grid uk-flex-top uk-flex-wrap-top" data-uk-grid="masonry: true">
			<!-- BEGIN: USERS_ROW -->
			<div>
