...
<div class="uk-background-default uk-section uk-padding-small"  uk-height-viewport="expand: true">
...
<!-- IF {PHP.cot_groups.4.desc} --><span class="uk-text-muted">{PHP.cot_groups.4.desc}</span><!-- ENDIF -->
