    ...
    <div id="tabs">
        ...
        <div class="uk-grid-small uk-child-width-expand@s uk-text-center" uk-grid>
          <div>
            <div v-on:click="activetab='1'" v-bind:class="[ activetab === '1' ? 'active' : '' ]">
              <a rel="ugc nofollow" href="{USERS_DETAILS_DETAILSLINK}" class="uk-button uk-button-details uk-width-1-1 
          ...
          <div>
            <div v-on:click="activetab='2'" v-bind:class="[ activetab === '3' ? 'active' : '' ]">
              <a rel="ugc nofollow" href="{USERS_DETAILS_MARKET_URL}" class="uk-button uk-button-details uk-width-1-1 
								...
								<!-- ENDIF -->">
                <span class="uk-margin-small-right" uk-icon="cart"></span>
                <span class="uk-text-middle">{PHP.L.market_myproducts} </span>
      ...
      <div class="content">
        <div v-if="activetab ==='1'" class="tabcontent" id="tab_info">
          <div>
            <script>
              document.title = '{USERS_DETAILS_NICKNAME} {PHP.L.User_account} {PHP.cfg.maintitle}';
            </script>
            <div class="uk-card">
                      ...
                      <div class="uk-width-1-2@s">
                        <div class=" uk-animation-slide-right">
                          ...
                          <a class="uk-width-medium-1-1 uk-button uk-button-success" href="{PHP|cot_url('sbr')}">
                            <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: {PHP.cfg.mainurl}/{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/img/icon/022-shield-1.svg" uk-svg="uk-preserve">
                  ...
                  <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-margin uk-margin-auto uk-margin-auto-left@m uk-card-body">
                      <ul class="uk-list uk-list-divider">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/company-date.svg" uk-svg="uk-preserve">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/otvet-person.svg" uk-svg="uk-preserve">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/lastloged.svg" uk-svg="uk-preserve">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/smartphone.svg" uk-svg="uk-preserve">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/map.svg" uk-svg="uk-preserve">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/clock.svg" uk-svg="uk-preserve">
                  ...
                  <div class="uk-card uk-card-default">
                    ...
                    <div class="uk-margin uk-margin-auto uk-margin-auto-left@m uk-card-body">
                      <ul class="uk-list uk-list-divider">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/telegram.svg" uk-svg="uk-preserve" uk-tooltip="TELEGRAM">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/facebook.svg" uk-svg="uk-preserve" uk-tooltip="FACEBOOK">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/whatsapp.svg" uk-svg="uk-preserve" uk-tooltip="WhatsApp">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/instagram.svg" uk-svg="uk-preserve" uk-tooltip="INSTAGRAM">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/YouTube_soc.svg" uk-svg="uk-preserve" uk-tooltip="YouTube">
                        ...
                        <li>
                          <img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/world-wide-web.svg" uk-svg="uk-preserve" uk-tooltip="{USERS_DETAILS_WWW_SITE_TITLE}">
