<!-- BEGIN: MAIN -->
<!-- пояснения по тэгам и экстраполям шаблона настройки учетных записей пользователем в своем профиле, находятся в файле users.profile.supplier.tpl.xlsx проверка сделана 19.03.2021 
    ...
    <div class="uk-container">
		...
		<form action="{USERS_PROFILE_FORM_SEND}" method="post" enctype="multipart/form-data" name="profile" class="uk-form-stacked">
			...
			<div class="uk-grid-small uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">
				...
				<div>
					<div class="uk-card uk-card-default uk-padding-small uk-border-rounded">
						<label class="uk-form-label"><span class="uk-text-danger" uk-icon="icon: clock; ratio: 1.2"></span><span class="uk-text-bold uk-link-text uk-margin-small-left uk-text-middle">{USERS_PROFILE_TIME_WORKING_TITLE}</span></label>
						<div class="uk-form-controls">
							{USERS_PROFILE_TIME_WORKING}
						</div>
					</div>
				</div>
				<!-- ENDIF -->
				...
				<div>
					<div class="uk-card uk-card-default uk-padding-small uk-border-rounded">
						<label class="uk-form-label"><img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/facebook.svg" uk-svg="uk-preserve"  uk-tooltip="FACEBOOK">
						<span class="uk-text-middle">
							{USERS_PROFILE_FACEBOOK_TITLE}
						</span>
						</label>
						<div class="uk-form-controls">
							{USERS_PROFILE_FACEBOOK}
						</div>
					</div>
				</div>
				<!-- ENDIF -->
				...
				<div>
					<div class="uk-card uk-card-default uk-padding-small uk-border-rounded">
						<label class="uk-form-label"><img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconsoclogo/instagram.svg" uk-svg="uk-preserve"  uk-tooltip="{USERS_PROFILE_INSTAGRAM_TITLE}">
						<span class="uk-text-middle">
							{USERS_PROFILE_INSTAGRAM_TITLE}
						</span>
						</label>
						<div class="uk-form-controls">
							{USERS_PROFILE_INSTAGRAM}
						</div>
					</div>
				</div>
				<!-- ENDIF -->
				...
				<div>
					<div class="uk-card uk-card-default uk-padding-small uk-border-rounded">
						<label class="uk-form-label"><img class="uk-margin-small-right" width="27" height="27" alt="" uk-img="data-src: themes/{PHP.theme}/img/iconuserdet/world-wide-web.svg" uk-svg="uk-preserve"  uk-tooltip="{USERS_PROFILE_WWW_SITE_TITLE}">
						<span class="uk-text-middle">
							{USERS_PROFILE_WWW_SITE_TITLE}
						</span>
						</label>
						<div class="uk-form-controls" uk-tooltip="Введите ссылку на ваш сайт, если таковой имеется. Не имеет значения с HTTP, HTTPS, WWW или вообще без них.">
							{USERS_PROFILE_WWW_SITE}
						</div>
					</div>
				</div>
				<!-- ENDIF -->
			...
			<div class="uk-margin">
				<div class="uk-card uk-card-default uk-padding-small uk-border-rounded">
					...
					<div class="uk-width-1-2@m uk-align-center">
						{USERS_PROFILE_VIDEO_COMPANY_MP4}
					</div>
					</div>
				</div>
