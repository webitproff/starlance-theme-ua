<!-- BEGIN: MAIN -->
<!-- пояснения по тэгам и экстраполям шаблона настройки и редактирования АДМИНИСТРАТОРОМ учетных записей профиля пользователя участника сообщества, находятся в файле users.edit.tpl.xlsx  
...
<div class="uk-section uk-section-muted">
    <div class="uk-container">
        ...
        <h3 class="uk-heading-bullet">Редактирование карточки профиля - <span class="uk-text-bold uk-text-success">{USERS_EDIT_MAINGRP}</span></h3>
