...
<div id="listprojects">
	...
	<!-- BEGIN: PRJ_ROWS -->
		<div class="uk-card uk-background-muted uk-card-body uk-card-small uk-border-rounded uk-scrollspy-inview uk-animation-fade uk-margin-bottom uk-box-shadow-small">
						...
						<div class="uk-grid-small uk-flex-middle" uk-grid>
							...
							<div class="uk-width-expand">
								<h6 class="uk-margin-remove-bottom uk-text-truncate">
									<a class="" href="{PRJ_ROW_OWNER_DETAILSLINK}"><!-- IF {PRJ_ROW_OWNER_FIRST_SECOND_NAME} --><span class="uk-text-emphasis">{PRJ_ROW_OWNER_FIRST_SECOND_NAME}</span><!-- ENDIF -->[{PRJ_ROW_OWNER_NICKNAME}]</a>
