		...
		<div id="ajaxBlock">
			...
			<div class="uk-card uk-card-small uk-card-body">
			   	<div class="uk-flex-middle uk-grid">
					...
					<!-- IF {DSSEND_TOUSER_AVATAR_SRC} --><img class="avatar uk-border-circle" width="50" height="50" alt="" src="{DSSEND_TOUSER_AVATAR_SRC}"><!-- ELSE --><img class="avatar uk-border-circle" width="50" height="50" alt="" src="themes/{PHP.theme}/img/avatar.png"><!-- ENDIF -->
