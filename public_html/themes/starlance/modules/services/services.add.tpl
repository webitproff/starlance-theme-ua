<!-- BEGIN: MAIN -->
<!-- BEGIN: SERVICES_ADD_PAYPRO_LIMIT -->
...
<!-- END: SERVICES_ADD_PAYPRO_LIMIT --> {FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/warnings.tpl"} <div class="uk-section uk-margin-auto-vertical">
  <div class="uk-container uk-background-muted uk-border-rounded">
    <h3 class="uk-margin-top uk-heading-bullet uk-text-uppercase uk-text-bold uk-link-text"> {PHP.L.services_add_service_title}</h3>
    ...
    <form action="{SERVADD_FORM_SEND}" method="post" name="newwork" enctype="multipart/form-data" class="uk-form-stacked uk-margin-large">
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <div class="uk-inline uk-width-1-1"> {SERVADD_FORM_CAT} </div>
        </div>
      </div>
      <div class="uk-margin">
        <h4 class="uk-heading-divider uk-text-primary uk-margin-remove">
        ...
        <code>H1</code>
        <label class="uk-text-secondary uk-text-light uk-text-small">Название услуги. Обязательно!</label>
        <div class="uk-form-controls">
          <div class="uk-inline uk-width-1-1">
            ...
            <input class="uk-input uk-width-1-1" type="text" name="rtitle" value="" placeholder="Аэротакси по городу. Пассажирские перевозки вертолетом.">
          </div>
        ...
        <div class="uk-margin">
          ...
          <div class="uk-form-controls">
            <div class="uk-inline uk-width-1-1">
              ...
              <input class="uk-input uk-width-1-1" type="text" name="rmetatitle" value="" maxlength="255" placeholder="Заказать аэротакси по Москве. Частный вертолет">
            </div>
            ...
            <div class="uk-modal-dialog uk-modal-body uk-background-muted uk-border-rounded uk-margin-auto-vertical">
              ...
              <div class="">
                ...
                <ul class="uk-list uk-list-decimal">
                  ...
                  <li>Мета Title должен быть релевантен запросу пользователя, который по ту сторону монитора ищет в поисковике, где можно <span class="uk-text-danger">Заказать аэротакси по Москве. Частный вертолет</span>
                  </li>
        ...
        <div class="uk-margin">
          ...
          <div class="uk-form-controls">
            <div class="uk-inline uk-width-1-1">
              ...
              <textarea class="uk-textarea" name="rmetadesc" placeholder="Скорая доставка пассажиров частным вертолетом по Москве. Заказать частный вертолет и добраться без пробок." rows="2" maxlength="255"></textarea>
            </div>
        ...
        <div class="uk-width-1-2@m">
          <div class="uk-margin">
            ...
            <div class="uk-form-controls" uk-tooltip="URL, ЧПУ, - уникальный на весь сайт идентификатор материала">
              <div class="uk-inline uk-width-1-1"> {SERVADD_FORM_ALIAS} </div>
            </div>
          </div>
        </div>
        <div class="uk-width-1-2@m">
          <div class="uk-margin">
            ...
            <label class="uk-form-label"></label>
            <div class="uk-form-controls">
              <div class="uk-inline uk-width-1-1" uk-tooltip="Разметка для форматирования текстового описания материала"> {SERVADD_FORM_PARSER} </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls"> {SERVADD_FORM_TEXT} </div>
      </div>
      <!-- IF {PHP.cot_plugins_active.locationselector} -->
      <div class="uk-margin">
        <h4 class="uk-heading-divider uk-text-primary uk-margin-remove">{PHP.L.Location}:</h4> {SERVADD_FORM_LOCATION}
      </div>
      <!-- ENDIF -->
      <div uk-grid>
        <div class="uk-width-1-4@m">
          <h4 class="uk-heading-divider uk-text-primary uk-margin-remove">{PHP.L.services_price}:</h4>
          <label class="uk-form-label"></label>
          <div class="uk-form-controls uk-position-relative"> {SERVADD_FORM_COST} <span class="uk-position-center-right uk-position-small">{PHP.cfg.payments.valuta}</span>
          </div>
        </div>
        <div class="uk-width-expand@m">
          <!-- IF {PHP.cot_plugins_active.servicesorders} -->
          <div class="uk-margin">
            <label class="uk-form-label uk-text-bold">{PHP.L.servicesorders_file}</label>
            <div class="uk-form-controls uk-background-muted uk-padding-small"> {SERVADD_FORM_FILE} </div>
          </div>
          <!-- ENDIF -->
        </div>
      </div>
      ...
      <div class="uk-margin">
        ...
        <label class="uk-form-label"></label>
        <div class="uk-form-controls uk-background-muted uk-padding-small"> {PHP|att_filebox('services', 0)} </div>
      </div>
      <!-- ENDIF -->
	  <!-- IF {SERVADD_FORM_ALLOW_ONLINE_ORDER} -->
      <div class="uk-margin-top">
        <div class="uk-alert-danger uk-border-rounded" uk-alert>
          <label class="uk-form-label uk-text-bold uk-text-danger">{SERVADD_FORM_ALLOW_ONLINE_ORDER_TITLE}:</label>
          <div class="uk-form-controls uk-margin-small"> {SERVADD_FORM_ALLOW_ONLINE_ORDER} </div>
        </div>
      </div>
	  <!-- ENDIF -->
