...
<div class="uk-background-muted uk-section">
	<div class="uk-container">
		...
		<div class="starlance-bg-darkgreenblue uk-padding-small uk-panel">
			<h5 class="uk-heading-divider uk-margin-remove"><span class="uk-light uk-text-uppercase uk-text-middle">{FORUMS_EDITPOST_SUBTITLE}</span></h5>
		</div>
		<!-- ENDIF -->
			{FILE "{PHP.cfg.themes_dir}/{PHP.usr.theme}/warnings.tpl"}
		<div class="uk-card uk-card-small uk-card-body uk-card-default uk-border-rounded-mdm uk-box-shadow-medium">
			<form action="{FORUMS_EDITPOST_SEND}" method="post" name="editpost" class="uk-form-stacked">
				...
				<div class="uk-margin">
					...
					<div class="uk-form-controls">
						<span class="uk-text-danger">{FORUMS_EDITPOST_EDITTIMEOUT}</span>
					</div>
				</div>
				<!-- ENDIF -->
				...
				<div class="uk-margin">
					<label class="uk-form-label">{PHP.L.Tags}: ({FORUMS_EDITPOST_TOP_TAGS_HINT})</label>
					<div class="uk-form-controls">
				...
				<div class="uk-margin uk-text-center">
					<button class="uk-button uk-button-linear" type="submit">{PHP.L.Update}</button>
				</div>
			</form>
		</div>
	</div>
