...
<div class="uk-background-muted uk-section uk-padding-remove-vertical"> 
	...
	<div class="uk-margin-top uk-margin-large-bottom">
		<div uk-grid>
			...
			<!-- ENDIF -->
				<a uk-tooltip="{PHP.L.Edit}" class="uk-icon-button uk-button-danger" href="{PRD_ID|cot_url('folio','m=edit&id='$this)}" uk-icon="icon:  file-edit; ratio: 1.2" title=""></a>
			</div>
			<!-- ENDIF -->
		</div>
		<!-- IF {PRD_STATE} == 2 -->
		...
		<div class="uk-grid-small" uk-grid> 
			<div class="uk-width-2-3@m">
				...
				<iframe src="https://www.youtube-nocookie.com/embed/{PRD_YOUTUBE_LINK_FOLIO}?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1&amp;enablejsapi=1" allowfullscreen="" uk-responsive="" uk-video="autoplay: false" class="uk-responsive-width" style="height: 394px;" width="1920" height="1080" frameborder="0"></iframe>
				</div>
				<!-- ENDIF -->
	...
	<div class="uk-container uk-container-large"> 
		<div class="uk-grid-small" uk-grid>
			<div class="uk-width-2-3@m">
			<!-- IF {PHP.cot_plugins_active.commentsfolio} -->
				<div class="uk-card uk-margin-small uk-border-rounded">
					<h3 class="uk-heading-line uk-text-center"><span>{PHP.L.comments_comments}: {PRD_COMMENTS_COUNT}</span></h3>
					<div>{PRD_COMMENTS_DISPLAY}</div>		
				</div>
			<!-- ENDIF -->	
			</div>
			<div class="uk-width-1-3@m">
				...
				<!-- IF {PHP.tag_i} > 0 -->
				<div class="uk-card uk-card-body uk-card-small uk-background-default uk-visible@l  uk-border-rounded-mdm">
				<hr class="uk-divider-icon">
					<div class="uk-flex uk-flex-center">
					<!-- BEGIN: PRD_TAGS_ROW -->
					<!-- IF {PHP.tag_i} > 0 -->, <!-- ENDIF --><a href="{PRD_TAGS_ROW_URL}" title="{PAGE_TAGS_ROW_TAG}" rel="nofollow">{PRD_TAGS_ROW_TAG}</a>
					<!-- END: PRD_TAGS_ROW -->
					<!-- BEGIN: PRD_NO_TAGS -->
					{PRD_NO_TAGS}
					<!-- END: PRD_NO_TAGS -->
