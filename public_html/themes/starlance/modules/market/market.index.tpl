        ...
        <div>
          <div class="uk-card uk-background-default">
            ...
            <div class="uk-padding-small uk-background-default">
              ...
              <div data-att-display="all"> {PRD_ROW_ID|att_display('market',$this,'','attacher.display.marketlist','all')} </div>
              <!-- ENDIF -->
              <h3 class="uk-heading-bullet uk-margin-remove uk-h5">
                <a class="uk-link-text" href="{PRD_ROW_URL}" title="{PRD_ROW_SHORTTITLE}" uk-tooltip="{PRD_ROW_SHORTTITLE} - Открыть полную страницу карточки товара или услуги">
                  ...
                  <div class="uk-modal-dialog uk-card uk-padding-small uk-background-primary uk-border-rounded-mdm uk-margin-auto-vertical uk-width-2-3@m uk-width-1-2@xl">
                    ...
                    <div class="uk-modal-footer">
                      <div class="uk-grid-small uk-child-width-1-2@s  uk-flex-center uk-text-center" uk-grid>
                        ...
                        <div>
                          <a class="uk-button uk-button-danger uk-width-1-1" <!-- IF {PHP.usr.id}> 0 -->href="{PRD_ROW_ID|cot_url('marketorders', 'm=neworder&pid='$this)}"
                            <!-- ELSE -->href="#AuthModal" uk-toggle
                            <!-- ENDIF -->> <span uk-icon="cart" class="uk-margin-small-right"></span>
                            <span class="uk-text-middle" uk-tooltip="{PHP.L.prd_marketorders_neworder_descr}" title="">{PHP.L.prd_marketorders_neworder_title}</span>
                          </a>
                        </div>
                        <!-- ENDIF -->
                        <!-- ENDIF -->
