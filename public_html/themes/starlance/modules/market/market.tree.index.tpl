...
<div class="uk-section uk-section-xsmall">
	<style>.mrktcontent{display: none;}</style>
	<div class="uk-container uk-container-large uk-margin-top uk-margin-bottom" id="index-market-cats">
		<header>
		<h3 class="uk-heading-bullet uk-text-uppercase uk-text-bold uk-link-text"><span uk-tooltip="{PHP.L.Prd_Marketplace_title}">{PHP.L.Prd_Marketplace}</span></h3>
		</header>
		...
		<div class="mrktcontent">
			<div class="uk-card uk-border-rounded-mdm uk-background-primary">
				...
				<div class="uk-padding-small">
					<a class="uk-link-text" uk-tooltip="{PHP.L.Prd_Cat_tooltip} «{ROW_TITLE}»" href="{ROW_HREF}"><span class="">{ROW_TITLE} ({ROW_COUNT})</span></a>
				</div>
			</div>
		</div>
		<!-- END: CATS -->
