...
<section class="uk-container uk-margin-large-top uk-margin-large-bottom">
	<div class="uk-card uk-card-body uk-background-muted uk-border-rounded"> 
		...
		{PHP.L.market_add_product_title}</h3>
		</header>
	...
	<div class="uk-margin">
		...
		<label class="uk-form-label uk-margin-remove-top"></label>
		<div class="uk-form-controls">
			{PRDADD_FORM_METADESC}
		</div>	
	</div>

		<div class="uk-width-1-2@m">
		<div class="uk-margin">
		<h4 class="uk-heading-divider uk-text-primary uk-margin-remove">{PRDADD_FORM_ARTICULE_N_TITLE}:</h4>
			<label class="uk-form-label"></label>
			<div class="uk-form-controls">
				<div class="uk-inline uk-width-1-1">
					{PRDADD_FORM_ARTICULE_N}
				</div>
			</div>
		</div>
		</div>
...
<!-- ENDIF -->	
	...
	<!-- IF {PRDADD_FORM_VIDEO_MP4} -->
	<div class="uk-margin">
		<h4 class="uk-heading-divider uk-text-primary uk-margin-remove">{PRDADD_FORM_VIDEO_MP4_TITLE}:</h4>
		<label class="uk-form-label"></label>		
		<div class="uk-form-controls"> 
			{PRDADD_FORM_VIDEO_MP4}
		</div>
	</div>
	<!-- ENDIF -->
